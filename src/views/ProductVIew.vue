<template>
    <section class="products">
        <div class="container">
            <div class="product-pharagraph">
                <h2 class="product-header--title">
                    Тануки
                </h2>
                <div class="product-card__description-info">
                    <div class="product-card__description-info--rating">
            ...
            <div class="products-wrapper">
                ...
                <div class="product-card" v-for="food in store.foods" :key="food.id">
                    <div class="product-card__image">
                        <img :src="getUrl(food.image)" alt="">
                    </div>
                    <div class="product-card__description">
                        <div class="product-card__description-row">
                            <h4 class="product-card__description--name">
                                {{ food.title }}
                            </h4>
                        </div>
                        <div class="product-card__description-row">
                            <p class="product-card__desctiption--text">
                                {{ food.recipe }}
                            </p>
                        </div>
                        <div class="product-card__description-row">
                            <div class="product-card__description-controls">
                                ...
                                <span class="product-card__description-controls--price"> {{ food.price }} &#8381;</span>
                            </div>
                        </div>
                    </div>
                </div>
...
const getUrl = (name) =>
{
    ...
    // return `@/assets/rests/pizzaPlus.jpg` 
}
</script>
...
.product-card__desctiption--text {
    color: #8c8c8c;
    font-weight: 400;
    font-size: 18px;
}
...
.product-card__description-controls>button,
.product-card__description-controls {
    align-items: center;
}
</style>